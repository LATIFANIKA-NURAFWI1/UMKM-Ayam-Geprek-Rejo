    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <flux:select wire:model.live="status" class="w-full sm:w-44">
                ...
                <flux:option value="confirmed">Dikonfirmasi</flux:option>
                <flux:option value="preparing">Dimasak</flux:option>
                <flux:option value="completed">Selesai</flux:option>
                <flux:option value="cancelled">Dibatal</flux:option>
            </flux:select>
        </div>
