<x-layouts::app :title="__('Menu Makanan')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <flux:select wire:model.live="kategori" class="w-full sm:w-48">
                <flux:option value="">Semua Kategori</flux:option>
            ...
            <flux:select wire:model.live="status" class="w-full sm:w-44">
                <flux:option value="">Semua Status</flux:option>
                <flux:option value="1">Tersedia</flux:option>
                <flux:option value="0">Tidak Tersedia</flux:option>
            </flux:select>
        </div>
