<div class="flex h-full w-full flex-1 flex-col p-6 bg-surface text-on-surface font-body-md antialiased">
    ...
    <div class="md:hidden flex items-center mb-6">
        ...
        <h1 class="font-headline-lg text-headline-lg font-bold text-on-surface">Tambah Menu</h1>
    </div>
                ...
                <div class="p-6 md:p-8 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div class="lg:col-span-4 flex flex-col gap-4">
                        <label class="font-body-lg text-body-lg text-on-surface">
                            Foto Menu <span class="text-error">*</span>
                        </label>
                        ...
                        <div class="border-2 border-dashed border-outline-variant rounded-xl bg-[#F1F3F5] flex flex-col items-center justify-center h-64 lg:h-full min-h-[300px] cursor-pointer hover:bg-surface-container-highest transition-colors group relative overflow-hidden"
                            ...
                            {{-- Hidden file input — bound to $image (bukan $photo) --}}
                    ...
                    <div class="lg:col-span-8 flex flex-col gap-6">
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="font-body-md text-body-md text-on-surface font-medium" for="nama">
                                Nama Menu <span class="text-error">*</span>
                            </label>
                            <input wire:model="name" id="nama" type="text"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {{-- Kategori --}}
                            <div class="flex flex-col gap-2">
                                <label class="font-body-md text-body-md text-on-surface font-medium" for="kategori">
                                    Kategori <span class="text-error">*</span>
                                </label>
                                <div class="relative">
                                    <select wire:model="category_id" id="kategori"
                            ...
                            {{-- Harga --}}
                            <div class="flex flex-col gap-2">
                                <label class="font-body-md text-body-md text-on-surface font-medium" for="harga">
                                ...
                                <div class="relative flex items-center">
                                    ...
                                    <input wire:model="price" id="harga" type="number" min="0" placeholder="0"
                        ...
                        <div class="flex flex-col gap-2 flex-grow">
                            <label class="font-body-md text-body-md text-on-surface font-medium" for="deskripsi">
                                Deskripsi Menu
                            </label>
                            <textarea wire:model="description" id="deskripsi" rows="5"
